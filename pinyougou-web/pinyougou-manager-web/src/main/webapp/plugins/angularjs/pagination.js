...
angular.module('pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '<li ng-click="firstPage()"><span>首页</span></li>' +
            ...
            '<li ng-click="lastPage()"><span>末页</span></li>' +
            '</ul>' +
        ...
        link: function(scope, element, attrs){
            ...
            scope.lastPage = function(){
                scope.conf.currentPage = (scope.conf.totalItems % scope.conf.itemsPerPage==0)?(scope.conf.totalItems/scope.conf.itemsPerPage):(scope.conf.totalItems/scope.conf.itemsPerPage+1);
            };
